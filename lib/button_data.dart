...
class ButtonData extends Searlizable implements HasId{
    ...
    ButtonData({this.id=defultId,Map<String,dynamic>? extendedProperties,this.label,this.image,this.sound,this.backgroundColor,this.borderColor, this.absoluteDimension,this.voclization}): extendedProperties = extendedProperties ??{};
    ...
    String? voclization = json[voclizationKey] is String ? json[voclizationKey].toString() : null;
    ImageData? image;
    ...
    List<String> absoluteDimensionKeys = [AbsoluteDimensionData.leftKey,AbsoluteDimensionData.topKey,AbsoluteDimensionData.widthKey,AbsoluteDimensionData.heightKey];
    ...
    return ButtonData(id:id,label:label,voclization:voclization,backgroundColor:backgroundColor,image:image,borderColor:borderColor,sound:sound,absoluteDimension: absoluteDimensionData, extendedProperties: getExtendedPropertiesFromJson(json));
   } 
    @override
...
class AbsoluteDimensionData extends Searlizable{
  ...
  AbsoluteDimensionData({double width=0,double height=0,double left=0,double top=0}){
    height = height;
    width = width;
    left = left;
    top = top;
  ...
  AbsoluteDimensionData.fromJson(Map<String,dynamic> json){
    ...
    width = json[widthKey] is num ? num.parse(json[widthKey].toString()).toDouble(): 0;
    height = json[heightKey] is num ? num.parse(json[heightKey].toString()).toDouble(): 0;
    left = json[leftKey] is num ? num.parse(json[leftKey].toString()).toDouble() : 0;
    top = json[topKey] is num ? num.parse(json[topKey].toString()).toDouble() : 0;
  }
  @override
  Map<String, dynamic> toJson() {
